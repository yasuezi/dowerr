...
read -p "👤 ADMIN_ID: " 932518771
read -p "📢 GROUP_ID: " -1001846051841
...
read -p "🤖 BOT_TOKEN: " 6587700262:AAEH4ZhkdbFoOLYB0EOTm945_Bn7XH8XDQ8
read -p "👥 ID_TELEGRAM UNTUK API: " snutzus
read -p "🔐 PASSWORD: " B@ngsat31
